            ...
            <div className="container blog-post">
                <div className="card mb-5">
                    ...
                    <div className="card-body blog-post__info">
                        ...
                        {(this.props.userInfo.userId === this.state.creator.id) && <Link to={`/blog/${this.props.match.params.blogId}`}><button className="btn btn-outline-info mr-3">EDIT BLOG</button></Link>}
